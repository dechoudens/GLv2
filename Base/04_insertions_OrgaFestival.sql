...
INSERT INTO org_genre VALUES(sq_org_genre.NEXTVAL, 'Reggaetón');
...
INSERT INTO org_artiste VALUES(sq_org_artiste.NEXTVAL, 'JayZ', 'Jay Z, anciennement Jay-Z de son vrai nom Shawn Corey Carter, né le 4 décembre 1969 à New York, est un rappeur et homme d''affaires américain. Il est l''un des artistes de hip-hop les mieux rémunérés d''Amérique', 1);
INSERT INTO org_artiste VALUES(sq_org_artiste.NEXTVAL, 'Muse', 'Muse est un groupe de rock britannique originaire de Teignmouth, dans le Devon, en Angleterre. Apparu sur la scène musicale en 1994, le trio est composé de Matthew Bellamy (chant, guitare, piano), Christopher Wolstenholme (basse, harmonica, chant, chœurs) et Dominic Howard', 2);
INSERT INTO org_artiste VALUES(sq_org_artiste.NEXTVAL, 'Alt-J', 'alt-J est un groupe de rock indépendant alternatif anglais originaire de Leeds composé de quatre musiciens et formé en 2007.', 16);                                                                        

INSERT INTO org_artiste VALUES(sq_org_artiste.NEXTVAL, 'Metronomy', 'Metronomy est un groupe de musique électronique et alternative formé en 1999 par Joseph Mount à Totnes, ville du sud du Devon en Angleterre. Le groupe actuel est composé de Joseph Mount (compositions, au chant, claviers et guitare), d''Anna Prior (batterie et au chant), d''Oscar Cash (saxophone, claviers, guitare et chœurs) et d''Olugbenga Adelekan (basse et chœurs).', 15);
...
INSERT INTO org_artiste VALUES(sq_org_artiste.NEXTVAL, 'Whitechapel', 'Whitechapel est un groupe de deathcore américain fondé en 2006.', 17);
INSERT INTO org_artiste VALUES(sq_org_artiste.NEXTVAL, 'Damian Marley', 'Damian Marley est un artiste musicien, producteur de disques et reggaeman né à Kingston, le 21 juillet 1978. Il est le fils de Bob Marley, d’où son surnom de « Junior Gong » qui lui vient de son père surnommé « Tuff Gong »', 20);
INSERT INTO org_artiste VALUES(sq_org_artiste.NEXTVAL, 'Caravan Palace', 'Caravan Palace est un groupe français de musique électronique dont le premier album est sorti en octobre 2008 chez Wagram Music.', 22);
INSERT INTO org_artiste VALUES(sq_org_artiste.NEXTVAL, 'Usher', 'Usher Terry Raymond IV né le 14 octobre 1978 à Dallas au Texas, est un chanteur de RnB, danseur, parolier, et acteur américain.', 28);
INSERT INTO org_artiste VALUES(sq_org_artiste.NEXTVAL, 'Michael Douglas', null, null);

-- ====================================================
-- Insertion Table : org_scene
-- ====================================================
INSERT INTO org_scene VALUES(sq_org_scene.NEXTVAL, 'Grande scène', 'C''est une grande scène', 10000, 150, 100, TO_DATE('08:00', 'hh24:mi'), TO_DATE('23:00', 'hh24:mi'), 1);
INSERT INTO org_scene VALUES(sq_org_scene.NEXTVAL, 'Petite scène', 'C''est une petite scène', 5000, 90, 80, TO_DATE('08:00', 'hh24:mi'), TO_DATE('23:00', 'hh24:mi'), 1);
...
INSERT INTO org_scene VALUES(sq_org_scene.NEXTVAL, 'EthnScene', 'Scène du monde', 1000, 100, 60, TO_DATE('08:00', 'hh24:mi'), TO_DATE('19:00', 'hh24:mi'), 1);

INSERT INTO org_scene VALUES(sq_org_scene.NEXTVAL, 'Scène Rouge', 'Genre : rock, metal', 2000, 100, 70, TO_DATE('08:00', 'hh24:mi'), TO_DATE('23:00', 'hh24:mi'), 2);
INSERT INTO org_scene VALUES(sq_org_scene.NEXTVAL, 'Scène Bleue', 'Electro', 5000, 90, 80, TO_DATE('08:00', 'hh24:mi'), TO_DATE('23:00', 'hh24:mi'), 2);
INSERT INTO org_scene VALUES(sq_org_scene.NEXTVAL, 'Scène Principal', 'C''est un chapiteau', 10000, 150, 100, TO_DATE('08:00', 'hh24:mi'), TO_DATE('23:00', 'hh24:mi'), 2);
INSERT INTO org_scene VALUES(sq_org_scene.NEXTVAL, 'Scène Verte', 'Jazz', 1000, 100, 60, TO_DATE('08:00', 'hh24:mi'), TO_DATE('23:00', 'hh24:mi'), 2);

INSERT INTO org_scene VALUES(sq_org_scene.NEXTVAL, 'Main stage', 'Scène principale', 2000, 50, 60, TO_DATE('08:00', 'hh24:mi'), TO_DATE('23:00', 'hh24:mi'), 3);
